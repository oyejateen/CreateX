...
const Sponsors = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      />
      <div className="relative z-10 flex flex-col  justify-start h-full text-white overflow-y-auto">
        <div className="sponsor-title font-kagitingan ml-10 text-4xl  pt-10 md:pt-20 sm:text-7xl text-2xl"
      style={{ display: "inline-flex",marginTop: "4rem" }}>
          Sponsors & Partners
        </div>
