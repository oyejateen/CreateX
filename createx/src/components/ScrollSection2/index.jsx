    ...
    <div className='about scroll-section'>
      ...
      <div className='about__container'>
        <div className='about__content'>
          ...
          <span className='ebo-container'><h1 className='about__content__heading--orange off-2'>Flat ₹20 off<span className='strikethrough'>₹100</span>₹80 /- </h1> ==> Contact the organizers </span>
          </h1>
